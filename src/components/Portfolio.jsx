  ...
  return (
    <div className="dark:bg-zinc-800 h-full py-12" name="portfolio">
      <div className="text-center mb-8 py-12">
        <p className="text-zinc-400 dark:text-white font-extralight text-xl py-4">
          What I Did
        </p>
      ...
      <div className="sm:grid sm:grid-cols-2 md:grid-cols-3 pb-12">
        <div className="mx-2 my-4 grid h-[480px] place-items-center">
          <a
            href="https://memrecihan.github.io/MovieList-React/"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <div>
            <p className="my-2 font-semibold text-xl dark:text-zinc-300">
              User functions:
            </p>
        ...
        <div className="mx-2 my-4 grid h-[480px] place-items-center">
          <a
            href="https://MEmreCihan.github.io/MyShoppingApp"
            target="_blank"
            rel="noreferrer"
          >
            <img
        ...
        <div className="mx-2 my-4 grid h-[480px]">
          <a
